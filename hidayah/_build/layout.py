...
"de": {
 ...
 "meta.desc":"Islamisches Wissen, Emru bil maruf nehyu anil munker – das Gebieten des Rechten und das Verbieten des Verwerflichen – und Orientierung auf Grundlage von Quran und Sunnah nach dem Verständnis der Sahabah und der frühen Generationen.",
 ...
 "menu":"Menü",
 "close":"Schließen",
 "hero.sub":"Islamisches Wissen. Emru bil maruf, nehyu anil munker. Orientierung.",
...
"en": {
 ...
 "meta.desc":"Islamic knowledge, emru bil maruf nehyu anil munker – enjoining the right and forbidding the wrong – and orientation grounded in the Quran and the Sunnah as understood by the Sahabah and the early generations.",
 ...
 "menu":"Menu",
 "close":"Close",
 "hero.sub":"Islamic knowledge. Emru bil maruf, nehyu anil munker. Orientation.",
...
"tr": {
 ...
 "meta.desc":"Sahabenin ve ilk nesillerin anlayışı üzere Kurân ve sünnet temelinde İslami ilim, emru bil maruf nehyu anil münker – iyiliği emretmek ve kötülükten sakındırmak – ve istikamet.",
 "nav.account":"Hesabım",
 ...
 "menu":"Menü",
 "close":"Kapat",
 "hero.sub":"İslami ilim. Emru bil maruf, nehyu anil münker. İstikamet.",
