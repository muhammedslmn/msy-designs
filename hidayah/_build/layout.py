...
"de": {
 ...
 "meta.desc":"Islamisches Wissen, Dawah und Orientierung auf Grundlage von Quran und Sunnah nach dem Verständnis der Sahabah und der frühen Generationen.",
 ...
 "menu":"Menü",
 "close":"Schließen",
 "hero.sub":"Islamisches Wissen. Dawah. Orientierung.",
 ...
 "areas.q.text":"Stelle deine islamische Frage und erhalte eine fundierte Antwort auf Grundlage islamischer Quellen.",
...
"en": {
 ...
 "meta.desc":"Islamic knowledge, dawah and orientation grounded in the Quran and the Sunnah as understood by the Sahabah and the early generations.",
 ...
 "menu":"Menu",
 "close":"Close",
 "hero.sub":"Islamic knowledge. Dawah. Orientation.",
 ...
 "areas.q.title":"Q &amp; A",
 "areas.q.text":"Ask your Islamic question and receive a well-founded answer based on Islamic sources.",
...
"tr": {
 ...
 "meta.desc":"Sahabenin ve ilk nesillerin anlayışı üzere Kurân ve sünnet temelinde İslami ilim, davet ve istikamet.",
 "nav.account":"Hesabım",
 ...
 "menu":"Menü",
 "close":"Kapat",
 "hero.sub":"İslami ilim. Davet. İstikamet.",
 ...
 "areas.q.text":"İslami sorunu sor, İslami kaynaklara dayalı sağlam bir cevap al.",
...
"ar": {
 ...
 "meta.desc":"علم شرعي ودعوة وهداية على أساس القرآن والسنة بفهم الصحابة والقرون الأولى.",
 "nav.account":"حسابي",
 ...
 "areas.q.text":"اطرح سؤالك الشرعي واحصل على جواب مؤصَّل من المصادر الشرعية.",
