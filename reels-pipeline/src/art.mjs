...
const torso = (x, y, fill = 'var(--accent)', s = 1) => `
...
export const ART = {
  ...
  chartUp: S(`
    ...
    <rect x="96"  y="238" width="58" height="98"  rx="10" fill="var(--sun)"/>
    <rect x="176" y="184" width="58" height="152" rx="10" fill="var(--accent)"/>
    <rect x="256" y="112" width="58" height="224" rx="10" fill="var(--teal)"/>
    <path d="M104 208 L192 152 L268 84" stroke="var(--red)" stroke-width="13"/>
    <path d="M232 76 H278 V122" stroke="var(--red)" stroke-width="13"/>`),

  /* Decline: same frame, arrow falling. */
  chartDown: S(`
    <path d="M62 336 H346 M62 336 V70"/>
    <rect x="96"  y="112" width="58" height="224" rx="10" fill="var(--teal)"/>
    <rect x="176" y="196" width="58" height="140" rx="10" fill="var(--sun)"/>
    <rect x="256" y="258" width="58" height="78"  rx="10" fill="var(--red)"/>
    <path d="M104 108 L192 186 L272 264" stroke="var(--red)" stroke-width="13"/>
    <path d="M278 218 V272 H226" stroke="var(--red)" stroke-width="13"/>`),

  /* Money / cost. */
  money: S(`
    <rect x="52" y="150" width="296" height="168" rx="22" fill="var(--teal)"/>
  ...
  /* Time pressure. */
  clock: S(`
    <circle cx="200" cy="214" r="128" fill="var(--sun)"/>
  ...
  /* Warning / risk. */
  warning: S(`
    <path d="M200 74 L352 328 H48 Z" fill="var(--sun)"/>
    <path d="M200 168 v76" stroke-width="16"/>
    <circle cx="200" cy="284" r="11" fill="var(--line)" stroke="none"/>`),

  /* Checked document / rules. */
  document: S(`
    <path d="M92 52 h150 l66 66 v230 a12 12 0 0 1-12 12 H92 a12 12 0 0 1-12-12 V64 a12 12 0 0 1 12-12Z" fill="#fff"/>
    <path d="M242 52 v66 h66"/>
    <path d="M124 190 h150 M124 240 h150 M124 290 h96" stroke-width="11"/>
    <circle cx="292" cy="292" r="58" fill="var(--teal)"/>
    <path d="M266 292 l18 20 l38 -44" stroke="#fff" stroke-width="14"/>`),

  /* Phone / social. */
  phone: S(`
    <rect x="118" y="40" width="164" height="320" rx="30" fill="var(--ink)"/>
    <rect x="138" y="76" width="124" height="228" rx="12" fill="var(--paper)"/>
    <rect x="156" y="98" width="88" height="62" rx="8" fill="var(--accent)" stroke-width="7"/>
  ...
  scale: S(`
    ...
    <path d="M84 128 L46 214 h76 Z" fill="var(--accent)"/>
    <path d="M316 128 L278 214 h76 Z" fill="var(--teal)"/>
    <circle cx="200" cy="112" r="15" fill="var(--sun)"/>`),

  /* Process / mechanics. */
  gears: S(`
    <circle cx="158" cy="176" r="76" fill="var(--accent)"/>
    ...
    <circle cx="286" cy="286" r="50" fill="var(--teal)"/>
  ...
  crowd: S(`
    <path d="M40 330 H360"/>
    ${torso(112, 268, 'var(--teal)', 1.15)}
    ${torso(288, 268, 'var(--sun)', 1.15)}
    ${torso(200, 254, 'var(--accent)', 1.45)}`),

  /* Goal reached. */
  flag: S(`
    <path d="M60 336 H340"/>
    <path d="M150 336 V78" stroke-width="13"/>
    <path d="M150 88 h150 l-34 48 l34 48 h-150 Z" fill="var(--red)"/>
    ${torso(268, 288, 'var(--teal)', 1.0)}`),
  ...
  /* Idea / key insight. */
  bulb: S(`
    <path d="M200 62 a96 96 0 0 1 60 171 v29 h-120 v-29 a96 96 0 0 1 60 -171Z" fill="var(--sun)"/>
